...
DJANGODIR=/home/dev/Desktop/Downloads/API                    # Django project directory
SOCKFILE=/home/dev/Desktop/Downloads/API/run/gunicorn.sock  # we will communicte using this unix socket
USER=root
GROUP=root
